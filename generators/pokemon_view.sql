            ...
            from (
                ...
                ,(
                    ...
                    from (
                        ...
                        where "set_move"."list" = "bfset"."list" and "set_move"."set_index" = "bfset"."index"
                        order by "set_move"."move_index"
                    ) as "move"
                ) as "moves"
                ,(
                    ...
                    from (
                        ...
                        where "set_ev"."list" = "bfset"."list" and "set_ev"."set_index" = "bfset"."index"
                        order by "stat"."order"
                    ) as "ev"
                ) as "evs"
                ...
                order by "bfset"."list", "bfset"."index"
            ) as "bfset"
        ) as "bfsets"
