select "tp"."trainer_name", "tp"."pokemon", "tp"."form", "tp"."level", "i"."name", "a"."name" as "ability", "tp"."nature", "tp"."ivs",
...
where 
	("tp"."trainer_type" = 'REGIGIGAS' and "tp"."trainer_name" = 'Regigigas' and "tp"."trainer_id" = 0)
	or
	("tp"."trainer_type" = 'REGIGIGAS' and "tp"."trainer_name" = 'Regigigas' and "tp"."trainer_id" = 0)

order by "tp"."trainer_type", "tp"."trainer_name", "tp"."trainer_id", "tp"."index"